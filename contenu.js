...
window.CONTENU = {
	...
	ruban: [
		...
		"24 pays d'intervention",
		'850 écoles équipées',
		'15 000 enfants accompagnés',
		'12 000 bénévoles',
		'Depuis 2000'
	],
	...
	galerie_accueil: {
		...
		// # Bloc vert de la galerie
		note_chiffre: '45 000',
		note_label: 'Enfants scolarisés',
		note_texte:
			"Chaque photo vient d'une école que nous accompagnons, du premier cours au dernier diplôme.",
	...
	impact: {
		...
		chapeau:
			"Chaque chiffre représente une vie transformée, un avenir bâti grâce à l'éducation.",
		blocs: [
			{
				chiffre: '45 K',
	...
	transparence: {
		...
		chiffre: '85 %',
		chiffre_legende:
			'des fonds sont consacrés directement à nos programmes.',
		repartition: [
			{
	...
	temoignages: {
		...
		liste: [
			{
				citation:
					"Grâce à Libota, mon fils a pu accéder à une éducation de qualité malgré nos difficultés financières. L'association a changé notre vie.",
				auteur: 'Marie Lefebvre',
				role: 'Parent bénéficiaire'
			},
			{
				citation:
					"Être bénévole chez Libota est une expérience enrichissante. Voir les enfants grandir et apprendre, c'est la plus belle des récompenses.",
				auteur: 'Thomas Bernard',
				role: 'Bénévole depuis 2018'
			},
			{
				citation:
					"Le partenariat avec Libota nous a permis d'équiper 12 écoles rurales. Un impact concret et mesurable sur le terrain.",
		...
		liste: [
			{
				...
				reponse:
					"Oui. Votre don ouvre droit à une réduction d'impôt de 66 % de son montant, dans la limite prévue par la loi. Un reçu fiscal vous est envoyé automatiquement par e-mail."
			},
			{
				question: 'Comment savoir où va mon argent ?',
				reponse:
					"Nous publions chaque année un rapport d'impact et notre bilan financier détaillé. 85 % des fonds sont consacrés directement à nos programmes sur le terrain."
			},
			{
				question: 'Puis-je faire un don mensuel ?',
				reponse:
					"Bien sûr. Lors de votre don, choisissez l'option « Mensuel ». Le don régulier nous permet d'inscrire nos actions dans la durée. Vous pouvez l'arrêter à tout moment."
			},
			{
				question: 'Comment devenir bénévole ?',
				reponse:
					'Rendez-vous sur notre page Contact et choisissez « Devenir bénévole ». Notre équipe vous recontacte sous 24 h pour trouver la mission qui vous correspond.'
			}
		]
	},
	...
	contact: {
		...
		newsletter_texte:
			"Recevez nos actualités et rapports d'impact directement dans votre boîte mail.",
	...
	apropos: {
		...
		appel_texte:
			"Chaque don nous rapproche d'un monde où chaque enfant a accès à l'éducation.",
	...
	projets: {
		...
		appel_texte:
			"Votre don soutient directement l'un de nos six pôles d'action sur le terrain.",
		appel_bouton: 'Faire un don'
	},
	...
	poles: [
		{
			...
			titre: 'Éducation',
			accroche:
				'Notre pôle historique : des écoles équipées, des manuels et un soutien scolaire pour que chaque enfant apprenne dans de bonnes conditions.',
			...
			beneficiaires:
				"Les enfants de 6 à 16 ans issus de familles défavorisées, en priorité dans les zones rurales et isolées de nos 24 pays d'intervention.",
			galerie: [
		...
		},
		{
			...
			titre: 'Santé & bien-être',
			accroche:
				'Suivi médical, campagnes de vaccination et programmes nutritionnels pour que chaque enfant apprenne dans de bonnes conditions.',
			...
			beneficiaires:
				'Les élèves des écoles partenaires et leurs familles, avec une priorité donnée aux zones sans accès à un centre de santé.',
			galerie: [
		...
		},
		{
			...
			video: 'https://videos.pexels.com/video-files/3209828/3209828-hd_1280_720_25fps.mp4',
			accroche:
				"Distribution de tablettes, salles informatiques et plateformes d'apprentissage à distance pour les zones rurales isolées.",
			...
			beneficiaires:
				"Les élèves et enseignants des écoles rurales isolées, là où la connexion et l'électricité restent intermittentes.",
			galerie: [
		...
		},
		{
			...
			accroche:
				'Programmes de formation continue pour les enseignants locaux, aux méthodes pédagogiques modernes et inclusives.',
			...
			beneficiaires:
				"Les enseignants des écoles publiques et associatives partenaires, et à travers eux l'ensemble de leurs élèves.",
			galerie: [
		...
		},
		{
			...
			titre: 'Bourses scolaires',
			accroche:
				"Financement de la scolarité, des fournitures et du transport pour les familles les plus vulnérables, jusqu'au diplôme.",
			...
			beneficiaires:
				'Les enfants et adolescents de familles à très faibles revenus, identifiés avec les écoles et les autorités locales.',
			galerie: [
		...
		},
		{
			...
			titre: 'Infrastructures',
			accroche:
				"Construction de classes, accès à l'eau potable et installations sanitaires pour des écoles sûres et durables.",
			...
			beneficiaires:
				"Les élèves et enseignants des écoles rurales, ainsi que les habitants des villages qui partagent les points d'eau.",
			galerie: [
	...
	projet_page: {
		...
		soutien_texte:
			"Votre don finance directement ce pôle d'action sur le terrain.",
	...
	equipe: {
		...
		benevoles_texte:
			'Sur le terrain ou à distance, nos bénévoles donnent de leur temps et de leur énergie. Ils animent les classes, forment les enseignants, organisent les collectes et portent notre voix partout dans le monde.',
		benevoles_chiffres: [
		...
		rejoindre_texte:
			'Bénévolat, mécénat de compétences ou poste salarié : il y a forcément une façon de contribuer qui vous ressemble.',
	...
	presse: {
		...
		kit_texte:
			'Journalistes : retrouvez nos communiqués, visuels HD et logos dans notre kit média.',
		kit_liens: [
	...
	page_contact: {
		...
		form_intro:
			'Remplissez ce formulaire, notre équipe vous répond sous 24 h ouvrées.',
		form_champs: {
			prenom: 'Prénom',
			nom: 'Nom',
